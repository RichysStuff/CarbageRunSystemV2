...
const i2c_device_addr_0 = 0x21;
const i2c_device_addr_1 = 0x20;

const i2c_device_config_reg_adr_port_0 = 0x6;
const i2c_device_config_reg_adr_port_1 = 0x7;
const i2c_device_output_reg_adr_port_0 = 0x2;
const i2c_device_output_reg_adr_port_1 = 0x3;

const channel_to_i2c_map = {	ch0: [i2c_device_addr_0, i2c_device_output_reg_adr_port_1, 5],  // device addr | port number | bit offset
                  	    	ch1: [i2c_device_addr_0, i2c_device_output_reg_adr_port_1, 4],
				ch2: [i2c_device_addr_0, i2c_device_output_reg_adr_port_1, 3],  
                		ch3: [i2c_device_addr_0, i2c_device_output_reg_adr_port_1, 2],    
                		ch4: [i2c_device_addr_0, i2c_device_output_reg_adr_port_1, 1],   
   				ch5: [i2c_device_addr_0, i2c_device_output_reg_adr_port_1, 0],  
             			ch6: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 7],  
                		ch7: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 6],  
                		ch8: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 5],  
                		ch9: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 4],  
				ch10: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 3], 
                		ch11: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 2], 
               			ch12: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 1], 
               			ch13: [i2c_device_addr_0, i2c_device_output_reg_adr_port_0, 0],  
               			ch14: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 7], 
               			ch15: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 6], 
               			ch16: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 5], 
               			ch17: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 4], 
				ch18: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 3], 
				ch19: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 2],  
				ch20: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 1],  
				ch21: [i2c_device_addr_1, i2c_device_output_reg_adr_port_1, 0],  
				ch22: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 7],  
				ch23: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 6],  
				ch24: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 5],  
				ch25: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 4],  
				ch26: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 3],  
				ch27: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 2],  
				ch28: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 1],  
				ch29: [i2c_device_addr_1, i2c_device_output_reg_adr_port_0, 0]};
...
const intervalId = setInterval(async () => {
   ...
   try {
	...
	for (const light_key in lights_buffered){
		...
		if (equip_to_ch_map.hasOwnProperty(light_key)){
			...
			if(channel_to_i2c_map.hasOwnProperty(connected_ch)){
				...
				if(port_addr == i2c_device_output_reg_adr_port_0){
	...
	i2c1= I2C.openSync(1);
	if(startup_latch != 1){
		i2c1.writeByteSync(i2c_device_addr_0, i2c_device_config_reg_adr_port_0, 0); // setup ports as output
		i2c1.writeByteSync(i2c_device_addr_0, i2c_device_config_reg_adr_port_1, 0);
		i2c1.writeByteSync(i2c_device_addr_1, i2c_device_config_reg_adr_port_0, 0);  
        	i2c1.writeByteSync(i2c_device_addr_1, i2c_device_config_reg_adr_port_1, 0);
		startup_latch = 1;
	}

	i2c1.writeByteSync(i2c_device_addr_0, i2c_device_output_reg_adr_port_0, dev_0_data & 0xFF); //write out new data
	i2c1.writeByteSync(i2c_device_addr_0, i2c_device_output_reg_adr_port_1, (dev_0_data >> 8) & 0xFF);
	i2c1.writeByteSync(i2c_device_addr_1, i2c_device_output_reg_adr_port_0, dev_1_data & 0xFF);
        i2c1.writeByteSync(i2c_device_addr_1, i2c_device_output_reg_adr_port_1, (dev_1_data >> 8) & 0xFF);
      	i2c1.closeSync();
